            ...
            if (1)
            {
                ...
                if (alarmCode)
                {
                    if (MotionStatus.alarm != true)
                    {
                        ...
                        debugOut(0, "[\t%d] Motor Alarm [first]:code->0x%X C:%f Vol:%f Speed:%f\r\n", osKernelSysTick(), alarmCode, MotionStatus.Current, MotionStatus.Voltage, agv.FeedBack_RPM);
                    }
                    else
                    {
                        MotionStatus.alarm = true;
                        ...
                        {
                            debugOut(0, "[\t%d] Motor Alarm: code->0x%X C:%f Vol:%f Speed:%f\r\n", osKernelSysTick(), alarmCode, MotionStatus.Current, MotionStatus.Voltage, agv.FeedBack_RPM);
